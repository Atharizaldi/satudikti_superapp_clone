class GetDetailProdi {
  ...
  GetDetailProdi.fromJson(Map<String, dynamic> json) {
  ...
  bool operator ==(Object other) {
    return other is GetDetailProdi &&
        data == other.data &&
...
class Data {
  ...
  @override
  bool operator ==(Object other) {
    return other is Data && prodi == other.prodi;
  }
...
class JenjangDidik {
  ...
  @override
  bool operator ==(Object other) {
    return other is JenjangDidik && id == other.id && nama == other.nama;
  }
...
class Pt {
  ...
  @override
  int get hashCode => Object.hash(id, kode, nama, namaSingkat);
}
