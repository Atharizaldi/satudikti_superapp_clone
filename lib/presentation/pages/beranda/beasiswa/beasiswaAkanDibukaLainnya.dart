...
class BeasiswaAkanDibukaLainnyaPage extends StatefulWidget {
  const BeasiswaAkanDibukaLainnyaPage({Key? key}) : super(key: key);

  @override
  State<BeasiswaAkanDibukaLainnyaPage> createState() =>
      _BeasiswaAkanDibukaLainnyaPageState();
}

class _BeasiswaAkanDibukaLainnyaPageState
    extends State<BeasiswaAkanDibukaLainnyaPage> {
  ScrollController scrollController = ScrollController();

  void onScroll(BuildContext context) {
    if (scrollController.position.pixels ==
        scrollController.position.maxScrollExtent) {
      listPaginationBeasiswaBloc.add(ListPaginationBeasiswaAkanDibukaEvent());
    }
  }
