...
class MajalahPopulerPage extends StatefulWidget {
  const MajalahPopulerPage({Key? key}) : super(key: key);

  @override
  State<MajalahPopulerPage> createState() => _MajalahPopulerPageState();
}

class _MajalahPopulerPageState extends State<MajalahPopulerPage> {
