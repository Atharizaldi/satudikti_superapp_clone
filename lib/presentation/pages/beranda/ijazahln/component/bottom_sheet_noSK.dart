...
class BottomSheetNomorSK extends StatefulWidget {
  final BuildContext siagaPageContext;
  final TextEditingController textEditingController;

  BottomSheetNomorSK({required this.siagaPageContext, required this.textEditingController}) : super();

  @override
  State<BottomSheetNomorSK> createState() => _BottomSheetNomorSKState();
}

class _BottomSheetNomorSKState extends State<BottomSheetNomorSK> {
  Timer? _debounce;
  ...
  void getDataHistory() async {
    ...
    setState(() {
      if(prefs.getStringList("nomorSK")!.isNotEmpty){
        historyList = prefs.getStringList("nomorSK")!;
      }
    });
  }
  ...
  Widget searchSection(TextEditingController textEditingController) {
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: styleWithSearchPrefix("Masukkan Nomor SK"),
        onEditingComplete: () async {
          ...
          if(textEditingController.text.isNotEmpty){
            ...
            prefs.remove("nomorSK");
            prefs.setStringList("nomorSK", historyList.toList(growable: false));
          }
