...
Widget pengajuanBaru(
  ...
  List<num> usulanUnder100Percent = [];

  for (int i = 0; i < usulanDetailList.length; i++) {
    usulanPercentages.add(usulanDetailList[i].progressPercentage);
  }

  usulanUnder100Percent = usulanPercentages.where((x) => x < 100).toList();

  if (usulanList.isEmpty || usulanUnder100Percent.isEmpty) {
                ...
                child: Row(
                  children: [
                    ...
                    CustomPercentIndicator(
                      ...
                      fontSize: 14,
                      containerColor:
                          dataDetail.detailUsulan.last.kelas == 'danger'
                              ? red
                              : green3,
                      progressColor:
                          dataDetail.detailUsulan.last.kelas == 'danger'
