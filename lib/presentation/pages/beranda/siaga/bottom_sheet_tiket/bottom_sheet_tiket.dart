...
class BottomSheetTiket extends StatefulWidget {
  final BuildContext siagaPageContext;
  final TextEditingController textEditingController;

  BottomSheetTiket({required this.siagaPageContext, required this.textEditingController}) : super();

  @override
  State<BottomSheetTiket> createState() => _BottomSheetTiketState();
}

class _BottomSheetTiketState extends State<BottomSheetTiket> {
  Timer? _debounce;
  ...
  void getDataHistory() async {
    ...
    setState(() {
      if(prefs.getStringList("nomorTiket")!.isNotEmpty){
        historyList = prefs.getStringList("nomorTiket")!;
      }
    });
  }
  ...
  Widget searchSection(TextEditingController textEditingController) {
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: styleWithSearchPrefix("Masukkan Nomor Tiket"),
        onEditingComplete: () async {
          ...
          if(textEditingController.text.isNotEmpty){
            ...
            prefs.remove("nomorTiket");
            prefs.setStringList("nomorTiket", historyList.toList(growable: false));
          }
