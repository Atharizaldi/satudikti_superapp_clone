...
class BottomSheetFormField extends StatefulWidget {
  final BuildContext cekStatusUsulanDosenPageContext;
  final TextEditingController textEditingController;
  final String hintText;

  BottomSheetFormField(
      {required this.cekStatusUsulanDosenPageContext,
...
class _BottomSheetFormFieldState extends State<BottomSheetFormField> {
  ...
  Widget buildHistoryList(List<String> listStringHistory,
                  ...
                  trailing: GestureDetector(
                    onTap: () async {
                      ...
                      setState(() {
                        ...
                        prefs.remove(textField);
                        prefs.setStringList(
                            textField, historyList.toList(growable: false));
                      });
                    },
