...
class LoadingDetailMahasiswaPDDikti extends StatefulWidget {
  const LoadingDetailMahasiswaPDDikti({Key? key}) : super(key: key);

  @override
  State<LoadingDetailMahasiswaPDDikti> createState() => _LoadingDetailMahasiswaPDDiktiState();
}

class _LoadingDetailMahasiswaPDDiktiState extends State<LoadingDetailMahasiswaPDDikti> {
  bool loading = true;
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      pddiktiKotak(judul: "Jenis Kelamin"),
                      SizedBox(
                        width: screenWidth(context) * (1 / 30),
                      ),
                      pddiktiKotak(judul: "Jenjang")
                    ],
                  ),
                  SizedBox(
                    height: 13.h,
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      pddiktiKotak(judul: "Semester Awal"),
                      SizedBox(
                        width: screenWidth(context) * (1 / 30),
                      ),
                      pddiktiKotak(judul: "Status Awal Mahasiswa")
                    ],
                  ),
                  SizedBox(
                    height: 13.h,
                  ),
                  pddiktiKotak(judul: "Status Mahasiswa Saat Ini")
                ],
              ),
            )
          ],
