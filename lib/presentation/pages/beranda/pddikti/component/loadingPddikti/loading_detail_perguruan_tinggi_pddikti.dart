...
class LoadingDetailPerguruanTinggiPDDikti extends StatefulWidget {
  const LoadingDetailPerguruanTinggiPDDikti({Key? key}) : super(key: key);

  @override
  State<LoadingDetailPerguruanTinggiPDDikti> createState() => _LoadingDetailPerguruanTinggiPDDiktiState();
}

class _LoadingDetailPerguruanTinggiPDDiktiState extends State<LoadingDetailPerguruanTinggiPDDikti> {
