...
class _SearchPageState extends State<SearchPage> {
              ...
              builder: (context, state) {
                if (state is SearchpageInitialState ||
                  ...
                  return Container(
                    width: double.infinity,
                    height: double.infinity,
                    child: resultPengumuman(context, textEditingController,
                        state.pengumumanList, widget.isPengumuman),
                  );
                  ...
                  Logger().i("Modul total: ${listModul.data.modul.length}");
                  Logger().i("Pengumuman total: ${pengumumanList.totalItem}");
                  Logger().i("News total: ${newsList.totalItem}");
                  ...
                  print("SearchpageNotFoundState");
                  return searchNotFound(widget.text);
                } else {
  ...
  void search(BuildContext context, String keyword) {
    print("SearchPage: KEYWORD SEARCH $keyword");
    if (mounted) {
